                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-44" >
                    <div className="" data-aos="fade-left">
                        ...
                        <form>
                            ...
                            <div className="flex justify-center mb-6">
                                <button type="submit" className="bg-primary hover:bg-darkprimary text-white px-7 py-4 rounded-sm w-full cursor-pointer font-semibold transition-all duration-200 hover:-translate-y-0.5 shadow-md">
                                    Subscribe
                                </button>
                            </div>
                        </form>
                    ...
                    <div className="lg:mt-0 mt-8">
                        <div className="flex justify-between items-center border-b border-border dark:border-dark_border focus:border-primary dark:focus:border-primary dark:bg-dark pb-6 mb-8 focus-visible:outline-none-10">
                            ...
                            <Link href="/blog" className="text-[#764DFF] hover:text-[#BD69F2] text-base font-semibold transition-colors">
                                View all
                            </Link>
                        </div>
