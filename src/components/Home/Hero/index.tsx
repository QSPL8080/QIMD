...
const HeroSection: React.FC<{ section?: any }> = ({ section }) => {
  ...
  return (
    <section
      className="relative overflow-hidden text-white pt-1.5 sm:pt-2 pb-4 sm:pb-5 lg:pb-6 border-b border-white/10"
      style={{
      ...
      <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-4 lg:gap-5 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between h-full space-y-2.5">
            ...
            <div className="bg-white dark:bg-dark text-midnight_text rounded-xl shadow-xl p-4 sm:p-4.5 border border-white/30 flex-1 flex items-center justify-center">
