...
const WhyQimdSection: React.FC = () => {
  ...
  return (
    <section
      className="py-12 sm:py-16 lg:py-20 overflow-hidden relative border-b border-slate-200/80 dark:border-dark_border"
      id="why-qimd"
      style={{
    ...
    >
      ...
      <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) px-4">
        ...
        <div className="text-center mb-8 sm:mb-10" data-aos="fade-up">
          <div className="inline-flex items-center gap-1.5 bg-primary/10 border border-primary/20 text-primary text-[11px] sm:text-xs font-bold px-3.5 py-1.5 rounded-full mb-3 shadow-xs backdrop-blur-sm">
