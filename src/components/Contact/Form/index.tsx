  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      const res = await submitContactEnquiryAction({
        ...
        phone: '9876543210',
        subject: formData.specialist || 'Consultation Request',
        message: `Requested Date: ${formData.date}, Time: ${formData.time}, Specialist: ${formData.specialist}`,
      });
      setLoader(false);
      if (res.success) {
        setSubmitted(true);
      ...
      setLoader(false);
      alert('Failed to submit contact enquiry');
    }
  };
