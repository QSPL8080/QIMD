          ...
          <div className="flex flex-col gap-2.5 mt-auto">
            ...
            {showBrochure && (
              <Link
                ...
                className="w-full border-[1.5px] border-[#764DFF]/35 hover:border-[#764DFF] bg-[#764DFF]/5 hover:bg-[#764DFF]/12 text-[#764DFF] text-sm font-semibold py-3 rounded-xl text-center transition-all duration-200 flex items-center justify-center gap-2 shadow-xs cursor-pointer"
              >
