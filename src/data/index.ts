...
export const testimonialsData: Testimonial[] = [
  ...
  },
  {
    ...
    courseTaken: "AI Powered Video Editing Course",
    review:
      "I had zero video editing experience when I joined QIMD. Today, I edit high-impact commercial reels, YouTube documentaries, and motion graphics for major clients. Learning Premiere Pro, After Effects, DaVinci Resolve, and AI video generators gave me an unfair advantage in interviews. The placement team actively set up interviews for me until I got selected!",
    rating: 5,
    ...
    studentStory: "From beginner to lead video editor at a production studio.",
    isFeatured: false,
  },
  {
    id: "test-004",
  ...
  },
  {
    ...
    courseTaken: "AI Powered Graphic Design Course",
    review:
      "QIMD's focus on practical projects rather than plain theory made all the difference. I was able to build a complete brand identity system from scratch, including UI design in Figma. The mock interview sessions boosted my confidence significantly before real client interviews.",
    rating: 5,
    image: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&q=80",
    role: "UI/UX & Brand Designer",
    company: "Tech Solution Ltd",
    isVideo: false,
    studentStory: "Cracked 3 job offers during campus placement drives.",
    isFeatured: false,
  },
];
