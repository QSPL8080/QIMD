...
export default function ReviewsTestimonialsPage() {
  ...
  return (
    <div className="bg-grey dark:bg-dark min-h-screen">
      ...
      {/* 2. WHY STUDENTS LOVE LEARNING AT QIMD (PROFESSIONAL 2-COLUMN FEATURE LAYOUT) */}
      <section className="py-16 lg:py-24 bg-white dark:bg-dark border-b border-slate-200/80 dark:border-dark_border">
        <div className="container mx-auto max-w-7xl px-4 lg:px-8 space-y-10">
          <div className="text-center max-w-3xl mx-auto space-y-3" data-aos="fade-up">
            <span className="text-xs font-extrabold uppercase tracking-widest text-[#764DFF]">The QIMD Advantage</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 max-w-5xl mx-auto">
            {whyStudentsLove.map((item, i) => (
              <div
                ...
                data-aos="fade-up"
                data-aos-delay={i * 40}
                className="flex items-center gap-4 p-4 sm:p-5 rounded-2xl bg-slate-50/80 dark:bg-darklight border border-slate-200/80 dark:border-dark_border shadow-2xs hover:border-[#764DFF]/40 hover:bg-white dark:hover:bg-dark transition-all duration-200 group"
              >
          ...
          <div className="container mx-auto max-w-7xl px-4 lg:px-8 space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {videoReviews.map((review) => (
                <div
                  key={review.id}
                  className="bg-white dark:bg-dark rounded-2xl p-5 border border-slate-200/80 dark:border-dark_border shadow-2xs hover:shadow-md transition-all flex flex-col justify-between"
                  data-aos="fade-up"
                >
                  <div>
                    <div
      ...
      {/* 4. WHAT OUR STUDENTS SAY (TEXT REVIEWS) */}
      <section className="py-16 lg:py-24 bg-white dark:bg-dark border-b border-slate-200/80 dark:border-dark_border" id="text-reviews">
        <div className="container mx-auto max-w-7xl px-4 lg:px-8 space-y-10">
            ...
            {combinedTextReviews.map((rev, i) => {
              ...
              return (
                <div
                  ...
                  data-aos="fade-up"
                  data-aos-delay={i * 80}
                  className="bg-slate-50/80 dark:bg-darklight p-6 rounded-3xl border border-slate-200/80 dark:border-dark_border shadow-2xs flex flex-col justify-between space-y-4 hover:border-[#764DFF]/40 transition-all"
                >
        ...
        <div className="container mx-auto max-w-7xl px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            ...
            >
              <div className="space-y-4">
                <div className="flex items-center gap-3 pb-3 border-b border-slate-200/60 dark:border-dark_border">
                  <div className="w-11 h-11 rounded-2xl bg-[#764DFF] text-white flex items-center justify-center shrink-0 shadow-md">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] font-bold text-[#764DFF] uppercase tracking-wider">Holistic Practical Approach</span>
                  </div>
                </div>
            ...
            >
              <div className="space-y-4">
                <div className="flex items-center gap-3 pb-3 border-b border-slate-200/60 dark:border-dark_border">
                  <div className="w-11 h-11 rounded-2xl bg-[#BD69F2] text-white flex items-center justify-center shrink-0 shadow-md">
                    <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] font-bold text-[#BD69F2] uppercase tracking-wider">Student Reviews</span>
                  </div>
                </div>
              ...
              <div className="space-y-3 pt-4 border-t border-slate-200/60 dark:border-dark_border/60">
                <a
                  href="https://g.page/r/QIMDInstitute/review"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-[#764DFF] hover:bg-[#5c38d6] text-white font-bold text-xs sm:text-sm py-3.5 px-6 rounded-2xl transition-all shadow-md flex items-center justify-center gap-2 group"
                >
                ...
                <Link
                  href="/contact"
                  className="w-full bg-white dark:bg-dark border border-slate-200/80 dark:border-dark_border text-[#764DFF] hover:bg-[#764DFF]/5 font-bold text-xs sm:text-sm py-3.5 px-6 rounded-2xl transition-all flex items-center justify-center gap-2 group"
                >
                  <Icon icon="mdi:pencil-box-outline" className="text-base" />
