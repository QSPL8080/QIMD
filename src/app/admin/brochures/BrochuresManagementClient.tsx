        ...
        setBrochures((prev) => {
          ...
          if (editingItem) {
            ...
            const newBrochure: BrochureItem = {
              ...
              courseName: selectedCourseObj?.courseName || 'Assigned Course',
    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
            ...
            Course Brochure Management CMS
          </h1>
          <p className="text-sm text-slate-500 mt-1">
            Manage course brochures, replace PDFs, activate/deactivate brochures, and configure automatic student lead downloads.
          </p>
        </div>
        <button
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="relative flex-1 w-full">
          <input
            type="text"
            placeholder="Search brochure by title or course name..."
            value={search}
      ...
      <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-xs">
        {filteredBrochures.length === 0 ? (
          <div className="p-12 text-center text-slate-400">
            ...
            <p className="font-semibold text-sm">No course brochures found.</p>
            <p className="text-xs text-slate-400 mt-1">Click &quot;Add New Brochure&quot; to upload a PDF brochure for a course.</p>
          </div>
        ) : (
                  ...
                  <tr key={item.id} className="hover:bg-purple-50/30 transition-colors">
                    ...
                    <td className="p-4 text-center">
                      <button
                        ...
                        title={item.isActive ? 'Click to deactivate' : 'Click to activate (will deactivate other brochures for this course)'}
                      >
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-7 max-w-lg w-full space-y-5 shadow-2xl border border-slate-200 max-h-[90vh] overflow-y-auto no-scrollbar">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                ...
                {editingItem ? 'Edit Course Brochure' : 'Add New Course Brochure'}
              </h2>
              <button
            ...
            <form onSubmit={handleSave} className="space-y-4 text-xs">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400 mt-1">
                  When a student submits the admission form for this course, this brochure will automatically download.
                </p>
              </div>
              ...
              <div className="flex items-center justify-between p-3.5 bg-slate-50 rounded-xl border border-slate-200">
                <div>
                  <span className="block font-bold text-slate-800 text-xs">Set as Active Course Brochure</span>
                  <span className="text-[10px] text-slate-500">
                    Only 1 active brochure per course. Activating this will automatically deactivate other brochures for this course.
                  </span>
                </div>
                <input
                  type="checkbox"
